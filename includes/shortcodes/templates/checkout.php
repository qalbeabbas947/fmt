...
<div class="ldnft-buy-now-widget">
    ...
    <p class='ld-licence-description'>
        ⓘ <span><?php echo __( 'A license entitles you to 1 year of updates and support. Each installation of the add-on will require a license key in order for you to receive updates and support.', 'ldninjas-freemius-toolkit' );?></span>
        <br><br>
    ...
    <input class="form-control" type="hidden" id="ldnft-checkout-plugin_name" value="<?php echo $plugin_name;  ?>" />
