...
<div  id="general_settings" class="cs_ld_tabs">
    <div class="ldfmt-tab-data-heading"><span class="fa fa-cog ldfmt-icon"></span> <?php _e( 'API Settings', 'ldninjas-freemius-toolkit' ); ?>
    </div> 
    <form id="ldnft-save-setting-form" method="post" action="<?php echo admin_url('admin-post.php'); ?>">
            ...
            <tbody class="ldnft-table-content">
                <tr> 
                    <td width="20%" align="left" valign="top">
						<strong><label align="left" for="ldnft_dev_id"><?php _e( 'Developer ID', 'ldninjas-freemius-toolkit' ); ?></label></strong>
					</td>
                    <td width="80%">
                        <input type="text" size="60" id="ldnft_dev_id" name="ldnft_settings[dev_id]" value="<?php echo $dev_id;?>">
                        <p class="description" style="font-weight: normal;">
                        <?php _e( 'Developer ID of the Freemius API', 'ldninjas-freemius-toolkit' ); ?>
                        </p>
                    </td>    
                </tr>   
				<tr> 
                    <td align="left" valign="top">
						<strong><label align = "left" for="ldnft_public_key"><?php _e( 'Public Key', 'ldninjas-freemius-toolkit' ); ?></label></strong>
					</td>
                    <td>
                        <input type="text" size="60" id="ldnft_public_key" name="ldnft_settings[public_key]" value="<?php echo $public_key;?>">
                        <p class="description" style="font-weight: normal;">
                            <?php _e( 'Public Key of the Freemius API', 'ldninjas-freemius-toolkit' ); ?>
                        </p>
                    </td>    
                </tr>
				...
				<tr> 
                    <td align="left" valign="top">
						<strong><label align = "left" for="ldnft_secret_key"><?php _e( 'Secret Key', 'ldninjas-freemius-toolkit' ); ?></label></strong>
					</td>
                    <td>
                        <input type="text" size="60" id="ldnft_secret_key" name="ldnft_settings[secret_key]" value="<?php echo $secret_key;?>">
                        <p class="description" style="font-weight: normal;">
                        <?php  _e('Scret Key of the Freemius API', 'ldninjas-freemius-toolkit' ); ?>
                        </p>
                    </td>    
                </tr>
                    ...
                    <tr> 
                        <td colspan="2" class="ldnft-process-freemius-data-info">
                            <div class="ldnft-process-freemius-data-log">
                                <div class="ldnft-loading-wrapper"><?php _e( 'Import is initiated', 'ldninjas-freemius-toolkit' ); ?>
        ...
        <div class="ldnft-submit-button submit-button" style="padding-top:10px">
            ...
            <a href="javascript:;" class="button button-primary ldnft-save-setting"><?php _e( 'Test & Save', 'ldninjas-freemius-toolkit' ); ?></a>
            <?php if( $fs_connection ) { ?>
                <a href="javascript:;" class="button button-primary ldnft-sync-data-setting"><?php _e( 'Sync Data', 'ldninjas-freemius-toolkit' ); ?></a>
            <?php } ?>
